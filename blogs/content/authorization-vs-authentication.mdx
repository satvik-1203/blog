...
description: Difference of Authentication and Authorization
language: 
---
...
Authentication is like a proof that the person accessing the route is you. In real terms you can also say 
...
url: https//:<username>:<password>@<domain> should do the trick.
```
...
$ curl -u <username>:<password> <domain>
```
